          ...
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                upload your own image to our databases(IPFS) .
              </h4>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Add your NFT description with traits.
              </h4>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Choose the image and description you want to mint and mint it.
              </h4>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Upgrade your NFT trait. That's it. You will get back a
                professional NFT.
              </h4>
            </div>
          </li>
